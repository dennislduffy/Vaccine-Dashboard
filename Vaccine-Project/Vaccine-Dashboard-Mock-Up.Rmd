...
map_labels <- paste(
  ...
  "Percentage Vaccinated: ", paste0(sprintf("%.1f", combined_data$proportion_vaxxed), "%")) %>% lapply(htmltools::HTML)
...
```{r}
# plot_ly(doses_data, type = 'scatter', mode = 'lines')%>%
#   add_trace(x = ~admin_week, y = ~doses_administered_per_week, name = 'Weekly Doses', 
#             line = list(color = 'rgb(0, 56, 101)'))%>%
#   layout(showlegend = F)
...
### Percent of Total Population with Complete COVID-19 Vaccine Series
